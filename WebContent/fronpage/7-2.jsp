...
<body>
	...
	request.setAttribute("album", AlbumDao.getById(albumId));
 	...
 	String[] tags = new String[] { "未分類", "頒獎典禮", "活動花絮", "環遊世界" };
 ...
 %>
							<div class="content_main span12">
								<div class="services_content first_service row-fluid">
									<h2 class="sub_title">
										<span class="little_title">活動櫥窗 ></span> <span
											class="little_title">${tags[param.tag]} ></span> ${album.title}
									</h2>
									<ul id="case_content">
										<%
											//Photo tmp = new Photo();
